...
function StartStore() {
    ...
    function FreshenStore(Character, Total) {
        ...
        $("#Inventory").html("<div class='MenuWrapper'><button class='MenuButton animated flipInY' id='Weapons'>Weapons</button><br><button class='MenuButton animated flipInY' id='Equipment'>Equipment</button></div>");
